# Showcase Package Image Credits

These images are used for package-theme previews and were sourced from Wikimedia Commons / Flickr records with commercial-use-friendly licences.

Images were resized for web performance (max dimension ~1600px) without changing subject matter.
...
6. **consulting-meeting.jpg**
   ...
   - Licence: **CC BY 2.0**
   - Licence URL: https://creativecommons.org/licenses/by/2.0
   - Source URL: https://commons.wikimedia.org/wiki/File:Meeting_with_a_business_development_representative_(7020915683).jpg
